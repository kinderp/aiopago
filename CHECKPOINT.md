...
- **Candidate/PR:** candidate = HEAD che contiene questa sezione; SHA esatto e draft PR vengono registrati dopo push (un commit non può contenere il proprio SHA). Push normale, no force; PR resta DRAFT, non mark-ready e non merge.
