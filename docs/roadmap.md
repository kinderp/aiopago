...
| **0.2-E — UX interattiva unificata** | Projection condivisa nel TUI e handoff umano semplificato | **READY FOR INDEPENDENT REVIEW**; issue #30, draft PR #31, independent gate 0/2 |
...
5. **0.2-E UX interattiva unificata: READY FOR INDEPENDENT REVIEW**, issue #30, draft PR #31, branch dedicato `feat/unified-human-ux-0.2-e`; independent gate 0/2.
