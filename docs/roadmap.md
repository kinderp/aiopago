...
| **0.2-D — Start da obiettivo** | `aio start <obiettivo>` con planning agent-driven e autorizzazione | **IN PROGRESS** su issue #27; nessun issue adapter |
...
4. **0.2-D Start da obiettivo: IN PROGRESS** su issue #27;
