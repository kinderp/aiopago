...
| **0.2-E — UX interattiva unificata** | Projection condivisa nel TUI e handoff umano semplificato | **REMEDIATION / gate 0/2** dopo Fresh Round 1 BLOCKED su R1-H-13/R1-M-13; nessun cleanup automatico di lock esistenti, package root senza runtime privilegiato, `aio` process boundary e Pi owned esatto 0.83.0; issue #30, draft PR #31 |
