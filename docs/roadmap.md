...
| **0.2-E — UX interattiva unificata** | Projection condivisa nel TUI e handoff umano semplificato | **REMEDIATION / gate 0/2** dopo Fresh Round 1 BLOCKED su R1-M-09/R1-M-10 e LOW R1-L-09; probe Windows fail-closed, deadline acquisizione e Runner read-only packed in nuova review; issue #30, draft PR #31 |
...
5. **0.2-E UX interattiva unificata: REMEDIATION / gate 0/2**, issue #30, draft PR #31, branch dedicato `feat/unified-human-ux-0.2-e`; il candidate `cf30a7da3a959dae33df023e94c3254aa26fcd0c` ha avuto Fresh Round 1 BLOCKED da R1-M-09/R1-M-10 e LOW R1-L-09. La remediation conserva schema lock 0.3.0, nonce, recovery hard-link e ABA, ma consente `DEAD` soltanto con prova OS positiva: PowerShell assente, exit generico, accesso negato, timeout e output malformato sono `UNKNOWN` e non rimuovono il lock. Un’unica deadline monotona di 10 secondi governa l’acquisizione dell’autorità takeover, inclusi probe e backoff. Il Runner packed espone soltanto facade read-only detached; storage/tracker/SafePoint/lifecycle e writer di journal/operation/calibration/artifact/metriche restano capability lessicali non raggiungibili. R1-M-01..M-08, R2 e la catena storica restano chiusi. Gate 0/2.
