...
$config=[ordered]@{schema='aiopago.operation-authority-service-config/1';serviceName=$ServiceName;serviceSid=$sid;root=$Root;protocol='aiopago.operation-authority-protocol/3';testScope=$true;brokerSha256=$brokerSha;nodeSha256=$nodeSha;workerSha256=$workerSha}
