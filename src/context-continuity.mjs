...
export { CONTEXT_SYNC_ENVELOPE_VERSION, CONTEXT_SYNC_PRIVACY_BOUNDARY_VERSION, CONTEXT_HANDOFF_BINDING_VERSION, CONTEXT_SYNC_PREFIX } from "./context-sync.mjs";
...
export { CONTEXT_HANDOFF_COMPATIBILITY_SCHEMA_VERSION, CONTEXT_HANDOFF_COMPATIBILITY_POLICY } from "./context-handoff-policy.mjs";
