...
test("protected handoff authority shares the current schema and canonical latch transaction", () => {
  const x = fixture();
  try {
...
test("bounded 1.1 latch store upgrade adds reservation schema while missing current schema fails closed", () => {
  ...
  assert.equal(upgraded.status().schema, "aiopago.operation-authority/1.4.0");
