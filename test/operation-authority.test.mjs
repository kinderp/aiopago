...
test("protected operation authority preserves Tracker profiles, outcomes, idempotency, and conflicts", () => {
  ...
  assert.deepEqual(authority.status(), {
    ...
    latch_canonical: true, handoff_reservation_canonical: true, lifecycle_binding_canonical: true, resume_authority_canonical: true, recovery_input_canonical: true, schema: "aiopago.operation-authority/1.5.0", journal_mode: "WAL", path: join(canonical, "operations.sqlite"),
  });
